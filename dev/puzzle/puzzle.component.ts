...
@Component({
    ...
    template: `
        ...
        >
            <h2>
                The Puzzle | {{switch1.value == switch1Number
                 && switch2.value == switch2Number
                 && switch3.value == switch3Number
...
export class PuzzleComponent implements OnInit {
    ...
    ngOnInit() {
        this.switch1Number = Math.round(Math.random()) + 1;
        this.switch2Number = Math.round(Math.random()) + 1;
        this.switch3Number = Math.round(Math.random()) + 1;
        this.switch4Number = Math.round(Math.random()) + 1;
